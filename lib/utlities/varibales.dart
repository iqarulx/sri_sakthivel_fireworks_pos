...
TextEditingController adminphoneno = TextEditingController();
TextEditingController adminuserid = TextEditingController();
...
List<CartDataModel> cartDataList = [];
List<BillingDataModel> billingProductList = [];
List<CustomerDataModel> customerList = [];

CustomerDataModel? customerInfo;

// Cart Section Variables
String discountSys = "%";
...
// Add Staff Page Variables
StaffDataModel? crtStaffData;
